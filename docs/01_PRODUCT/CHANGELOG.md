...
- Integrada a coverage intervalar compartilhada e os quatro Insights determinísticos de READ-004.
- Integrada a consulta autenticada `GET /books/{book_id}/insights`, por Book e all-time, read-only, sem persistência ou migration.
